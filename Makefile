all:
# Real Function 1D
	gcc -g -o out/opt-rf1d-rs -Isrc src/Main.c src/Problem/RealFunction1D/Problem.c src/Method/RandomSearch/Method.c

	gcc -g -o out/opt-rf1d-hc -Isrc src/Main.c src/Problem/RealFunction1D/Problem.c src/Method/HillClimbing/Method.c

	gcc -g -o out/opt-rf1d-es-mal -Isrc src/Main.c src/Problem/RealFunction1D/Problem.c src/Method/EvolutionStrategy/Method.c
...
# Real Function 2D
	...
	gcc -g -o out/opt-rf2d-rs -Isrc src/Main.c src/Problem/RealFunction2D/Problem.c src/Method/RandomSearch/Method.c

	gcc -g -o out/opt-rf2d-hc -Isrc src/Main.c src/Problem/RealFunction2D/Problem.c src/Method/HillClimbing/Method.c

	gcc -g -o out/opt-rf2d-es-mal -Isrc src/Main.c src/Problem/RealFunction2D/Problem.c src/Method/EvolutionStrategy/Method.c
