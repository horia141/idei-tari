all:
	...
	gcc -g -o out/opt-rf1d-ga-fps-opc -Isrc -Isrc/Method/GeneticAlgorithm src/Main.c src/Problem/RealFunction1D/Problem.c src/Method/GeneticAlgorithm/Method.c src/Method/GeneticAlgorithm/FitnessProportionateSelection.c src/Method/GeneticAlgorithm/OnePointCrossOver.c
	gcc -g -o out/opt-rf1d-ga-fps-tpc -Isrc -Isrc/Method/GeneticAlgorithm src/Main.c src/Problem/RealFunction1D/Problem.c src/Method/GeneticAlgorithm/Method.c src/Method/GeneticAlgorithm/FitnessProportionateSelection.c src/Method/GeneticAlgorithm/TwoPointCrossOver.c
	gcc -g -o out/opt-rf1d-ga-fps-uc -Isrc -Isrc/Method/GeneticAlgorithm src/Main.c src/Problem/RealFunction1D/Problem.c src/Method/GeneticAlgorithm/Method.c src/Method/GeneticAlgorithm/FitnessProportionateSelection.c src/Method/GeneticAlgorithm/UniformCrossOver.c
